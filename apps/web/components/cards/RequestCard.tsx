...
export default function RequestCard({ 
  ...
  return (
    <Link href={`/requests/${id}`} className="block">
      <div className="rounded-2xl bg-white dark:bg-gray-800 border border-gray-100 dark:border-gray-700 shadow-sm hover:shadow-md transition-shadow p-4 cursor-pointer">
