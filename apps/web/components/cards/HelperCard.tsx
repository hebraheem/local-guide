...
export default function HelperCard({ name, role, city, rating = 4.8, avatarSrc = "/svg/undraw_agreement_ftet.svg" }: Props) {
  return (
    <div className="rounded-2xl bg-white dark:bg-gray-800 border border-gray-100 dark:border-gray-700 shadow-sm hover:shadow-md transition-shadow p-3 flex gap-3">
