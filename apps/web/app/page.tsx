...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    keywords: "local guide, community help, translation, city tours, local services, helper network, errand assistance, study help, event guidance",
