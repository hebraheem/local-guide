...
export default async function RequestsPage() {
  ...
  const requests = [
    ...
    },
    {
      ...
      urgent: false,
      description:
        "I'm visiting Munich this weekend and would love a local guide to show me around.",
    },
    {
      id: 3,
    ...
    },
    {
      ...
      urgent: true,
      description:
        "Need help organizing and reviewing documents for visa extension application.",
    },
  ];
      ...
      <main className="mx-auto max-w-4xl px-4 py-6 space-y-6">
        ...
        <div>
          ...
          <p className="text-gray-600 dark:text-gray-400">
            {requests.filter((r) => r.urgent).length} urgent requests ·{" "}
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-700 dark:text-gray-300">
                Respond quickly to urgent requests to build your reputation.
                Clear communication leads to successful collaborations!
              </p>
            </div>
          </div>
        </div>
