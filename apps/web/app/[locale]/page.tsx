...
export async function generateMetadata({
  ...
  return {
    ...
    keywords:
      "local guide, community help, translation, city tours, local services, helper network, errand assistance, study help, event guidance",
...
const LandingPage = async () => {
  ...
  const services = [
    {
      key: "SERVICE_TRANSLATION",
      icon: "🌐",
      color: "bg-purple-100 dark:bg-purple-900",
    },
    {
      key: "SERVICE_MENTAL_HELP",
      icon: "💚",
    ...
    {
      key: "SERVICE_CITY_TOURS",
      icon: "🗺️",
      color: "bg-blue-100 dark:bg-blue-900",
    },
    {
      key: "SERVICE_FIND_OBJECTS",
      icon: "🔍",
      color: "bg-pink-100 dark:bg-pink-900",
    },
    {
      key: "SERVICE_RECEIVING",
      icon: "📦",
      color: "bg-orange-100 dark:bg-orange-900",
    },
    {
      key: "SERVICE_STUDY_HELP",
      icon: "📚",
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-gradient-to-b from-blue-50 to-white dark:from-gray-900 dark:to-gray-800">
        ...
        {/* About Section */}
        <section
          className="py-16 md:py-24 bg-gradient-to-b from-white to-blue-50 dark:from-gray-800 dark:to-gray-900"
          id="about"
        >
